...
<head>
	...
	<!--[if lte IE 9]>
		<link href="{{asset('packages/hifone/dashboard/css/browsers/lte-ie9.css')}}" media="all" type="text/css" rel="stylesheet">
	<![endif]-->
...
<body>
	...
	<script src="{{asset('packages/hifone/dashboard/js/base.js')}}"></script>
	@foreach ($myjs as $url)
		<script src="{{$url}}"></script>
	@endforeach
	<script src="{{asset('packages/hifone/dashboard/js/app.js')}}"></script>
